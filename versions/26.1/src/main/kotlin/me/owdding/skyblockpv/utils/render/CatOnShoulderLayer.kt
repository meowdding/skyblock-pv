...
class CatOnShoulderLayer(renderer: RenderLayerParent<AvatarRenderState, PlayerModel>, modelSet: EntityModelSet) :
    ...
    private val babyModel = BabyCatModel(modelSet.bakeLayer(ModelLayers.CAT))
    private val adultModel = AdultCatModel(modelSet.bakeLayer(ModelLayers.CAT))
    ...
    private fun submitOnShoulder(
        ...
        val catRenderState = CatRenderState()
