...
public class AvatarRenderStateMixin implements PlayerRenderStateAccessor {
    ...
    @Unique
    private Boolean skyblockpv$isCatBaby = null;
    @Unique
    ...
    public @Nullable Boolean getSkyblockpv$isCatBaby() {
        return this.skyblockpv$isCatBaby;
    }

    @Override
    public void setSkyblockpv$isCatBaby(@Nullable Boolean aBoolean) {
        this.skyblockpv$isCatBaby = aBoolean;
    }
